...
extra_cols=['INTERCO_TYPE=WITHIN_ENTITY','INTERCO_TYPE=SAME_REGION','INTERCO_TYPE=INTRA_REGION','INTERCO_TYPE=NON_SGCIB_ENTITY','ADJUSTMENT_TYPE=ODS/CNR','SOURCE_APPLICATION_ID=QTZ_MI','SOURCE_APPLICATION_ID=PEC/QTZ_MI','SOURCE_APPLICATION_ID=PEC_MI','INVENTORYIS-_RCG','INVENTORY=0_RCG','INVENTORYIS+_RCG','GLIS-_RCG','GL=0_RCG','GLIS+_RCG','BREAKIS-_RCG','BREAK=0_RCG','BREAKIS+_RCG','FIRSTBIT=1_APP_ORGIN_RCG','SECONDBIT=1_APP_ORGIN_RCG','THIRDBIT=1_APP_ORGIN_RCG']
  ...
  if adjustment_list[i]=='missing' or adjustment_list[i]=="['missing']":
    ...
    for j in org_list:
      if str(j)=='missing':
        ...
        bin_data.loc[i,item_s]=1
bin_data.to_csv('binarized_file_new_9ucc_GRIT_final.csv')

...
grit_e2k_data.fillna('missing', inplace=True)
#MERGING GRIT_E2K,GRIT_ADJ,PRC,MI,E2K,RCG
...
grit_initial_data.fillna('missing', inplace=True)
#MERGING GRIT_E2K,GRIT_ADJ,PRC,MI,E2K,RCG,GRIT_INITIAL
rcg_grit_d2_d3_e2k_join = pd.merge(rcg_mi_e2k_prc_merged, grit_initial_data,  how='left', left_on=['E2KACCT_NBR_RCG','BUS_UNIT_RCG','DEPT_ID_RCG','CCY_CD_RCG','ALTACCT_RCG'], right_on = ['ACCOUNT_GRIT_INITIAL','BUSINESS_UNIT_GRIT_INITIAL','DEPTID_GRIT_INITIAL','CURRENCY_GRIT_INITIAL','ALTACCT_GRIT_INITIAL'])
